...
const DepositInfoSection: React.FC<DepositInfoSectionProps> = ({
    depositBank,
    depositAccount,
    recipientName,
    onBankChange,
        ...
        <section className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                    <label className="text-xs font-semibold text-gray-400">입금 은행</label>
                    <input
                        type="text"
                        value={depositBank}
                ...
                <div className="space-y-2">
                    <label className="text-xs font-semibold text-gray-400">입금 계좌번호</label>
                    <input
                        type="text"
