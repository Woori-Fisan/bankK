                ...
                <div className="lg:col-span-2 space-y-8">
                    <Card padding="lg" className="border-slate-100 shadow-sm">
                        <div className="space-y-10">
                            ...
                            <div className="px-6 py-4 bg-emerald-50/50 rounded-2xl border border-emerald-100 flex items-center gap-3">
                                ...
                                <p className="text-xs text-emerald-700 font-bold">출금 계좌 정보가 맞는지 다시 한번 확인해 주세요.</p>
                            </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="p-8 bg-slate-50 rounded-3xl border border-slate-100">
                                    <p className="text-xl font-bold text-slate-600">{fromBankName}</p>
                                    <p className="text-3xl font-black text-slate-900 tracking-tight mt-1 font-mono">{fromAccountNumber}</p>
                                </div>
                            </div>

                            {/* 잔액 요약 */}
                            <div className="space-y-4">
                                <h3 className="text-xs font-black text-slate-400 uppercase tracking-widest">현재 잔액</h3>
                                <div className="p-8 bg-white border-2 border-slate-100 rounded-3xl flex items-baseline gap-2">
                                    <span className="text-xl font-bold text-slate-400">₩</span>
                                    <span className="text-4xl font-black text-slate-900">{formatAmount(balance || 0)}</span>
                    ...
                    <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100 flex items-start gap-4">
                        ...
                        <p className="text-xs text-slate-500 leading-relaxed font-medium">
                            위 계좌에서 이체 금액이 출금됩니다. 잔액이 부족할 경우 이체가 제한될 수 있습니다.
                        </p>
                    </div>
                </div>
                ...
                <div className="lg:col-span-1 space-y-6">
                    <Card padding="lg" className="bg-emerald-900 text-white border-none shadow-xl shadow-emerald-900/10 flex flex-col justify-between min-h-[200px]">
                        <div>
                            ...
                            <h4 className="text-xs font-bold text-emerald-100">계좌 상태</h4>
                        </div>
                        
                        <div className="py-2">
                            <p className="text-2xl font-black tracking-tight text-white">정상 (사용 가능)</p>
                        </div>
