        ...
        <div className="space-y-6">
            {isLoading && (
                <div className="flex items-center justify-center py-12">
                    ...
                    <span className="ml-3 text-base text-gray-500">서류 목록을 불러오는 중...</span>
                </div>
            )}

            {error && (
                <div className="p-4 bg-red-50 border border-red-200 rounded-xl">
                    <p className="text-base text-red-600">{extractApiError(error)}</p>
                </div>
            )}
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden">
                            <div className="p-6 border-b border-gray-100 bg-gray-50/50 flex items-center gap-2">
                                ...
                                <h3 className="text-lg font-bold text-gray-900">필수 제출 서류</h3>
                            </div>
                            <div className="p-6 space-y-3">
                                {mandatoryDocs.length > 0
                                    ? mandatoryDocs.map((doc, idx) => (
                                          ...
                                          >
                                              <div className="w-10 h-10 flex items-center justify-center bg-blue-50 text-blue-600 text-base font-bold rounded-full shrink-0">
                                                  {idx + 1}
                                              </div>
                        ...
                        <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden">
                            <div className="p-6 border-b border-gray-100 bg-gray-50/50 flex items-center gap-2">
                                ...
                                <h3 className="text-lg font-bold text-gray-900">선택 제출 서류</h3>
                            </div>
                            <div className="p-6 space-y-3">
                                {optionalDocs.length > 0
                                    ? optionalDocs.map((doc, idx) => (
                                          <div
                                              ...
                                              className="flex items-center gap-4 p-5 bg-gray-50 rounded-xl"
                                          >
                                              <div className="w-10 h-10 flex items-center justify-center bg-gray-100 text-gray-600 text-base font-bold rounded-full shrink-0">
                                                  {idx + 1}
                                              </div>
                                              <div className="flex-1">
                                                  <p className="text-base font-semibold text-gray-900">
                                              ...
                                              <span className="px-2.5 py-1 bg-blue-50 text-blue-600 text-xs font-bold rounded">
                                                  선택
                                              </span>
                                          </div>
                                      ))
            ...
            <div className="flex justify-end pt-6 border-t border-gray-200">
                <button
                    onClick={onNext}
                    className="flex items-center gap-2 px-12 py-5 bg-slate-900 text-white rounded-2xl font-black text-lg hover:bg-slate-800 active:scale-[0.98] transition-all"
                >
                    서류 제출하기
