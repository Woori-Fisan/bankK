...
import { FileCheck, FilePlus, Info, ShieldCheck, ChevronRight } from 'lucide-react';
                        ...
                        <div className="p-4 space-y-3">
                            {[
                                ...
                                <div key={doc.id} className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                                    ...
                                    <span className="px-2 py-1 bg-red-50 text-red-600 text-[10px] font-bold rounded">필수</span>
                                </div>
                            ))}
                        </div>
                    </div>
                        ...
                        <div className="p-4 space-y-3">
                            {[
                                ...
                                <div key={doc.id} className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                                    ...
                                    <span className="px-2 py-1 bg-blue-50 text-blue-600 text-[10px] font-bold rounded">선택</span>
                                </div>
                            ))}
                        </div>
                    </div>
