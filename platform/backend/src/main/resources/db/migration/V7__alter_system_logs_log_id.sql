-- 1. 기존 데이터 전체 삭제 (선행하여 이후 DDL 작업이 즉시 완료되도록)
TRUNCATE TABLE system_logs;

-- 2. jws_signature 컬럼 삭제, log_id 컬럼 추가
...
-- 5. 초기 파티션 설정 (이후 파티션 관리는 PartitionMaintenanceService 가 담당)
ALTER TABLE system_logs
