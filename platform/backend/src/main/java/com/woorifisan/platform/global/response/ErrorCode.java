...
public enum ErrorCode {
    ...
    //조회
    INQUIRY_ACCOUNT_NOTFOUND("INQUIRY_001", "고객 정보를 찾을 수 없습니다.", HttpStatus.BAD_REQUEST),
    ...
    LOAN_WEBHOOK_SECRET_INVALID("LOAN_008", "Webhook 인증에 실패했습니다.", HttpStatus.UNAUTHORIZED),
    LOAN_FILE_FORWARD_ERROR("LOAN_009", "파일 전달 중 오류가 발생했습니다.", HttpStatus.INTERNAL_SERVER_ERROR),
    // 출금
