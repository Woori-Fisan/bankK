...
BankBridge는 이 환경에 선제적으로 대응하기 위해, **우체국·상호금융 등 대행기관이 BaaS API를 통해 여신 상품 판매·계좌 조회·출금 업무를 처리**할 수 있도록 중계하는 플랫폼입니다.
...
| **금융실명거래법** | 실명 확인 업무는 금융회사에만 허용 | 은행대리업자 범위 포함 여부 법령 확인 필요 |

> **손해배상책임:** 혁신금융서비스 지정 조건에 따라, 대행기관의 행위로 인한 소비자 손해배상책임은 원칙적으로 **소속은행(위탁자)**에 귀속됩니다.
