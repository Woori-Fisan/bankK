...
public enum ErrorCode {
    ...
    TOKEN_REUSE_DETECTED("AUTH_005", "비정상적인 접근이 감지되었습니다. 다시 로그인해주세요.", HttpStatus.UNAUTHORIZED),
    ALREADY_LOGGED_OUT("AUTH_006", "이미 로그아웃된 세션입니다.", HttpStatus.UNAUTHORIZED),

    INTERNAL_SERVER_ERROR("ERR_002", "서버 내부 오류가 발생했습니다.", HttpStatus.INTERNAL_SERVER_ERROR),
    REDIS_CONNECTION_FAILURE("ERR_003", "인증 서버(Redis) 연결에 실패했습니다.", HttpStatus.SERVICE_UNAVAILABLE),
    ...
    NOT_EXIST_LOG("MON_005", "해당 로그 정보를 찾을 수 없습니다.", HttpStatus.NOT_FOUND),
